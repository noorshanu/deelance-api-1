...
const getTopCreator = catchAsync(async (req, res) => {
    ...
    const getResults = await getTransactionServices.getTopCreator(fromDate, toDate, page, limit, filter_Json_data, sort);
