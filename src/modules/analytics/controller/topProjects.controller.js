...
const topProjects = catchAsync(async (req, res) => {
    ...
    let body = req.body;
    const getResults = await analyticsServices.topProjects(startDate, endDate, page, limit, filter, sort);
