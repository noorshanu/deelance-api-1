 ...
 */
const topCreators = async (startDateParam, endDateParam, page, limit, filter, sort,) => {
    try {
        ...
        const uniqueCreatorCount = await Artwork.aggregate([
            ...
            },
            {
                $group: {
                    ...
                    createrCount: { $sum: 1 } // Count the number of students for each subject
                }
            },
            {
                $sort: { createrCount: -1 } // Sort by studentCount in descending order
            },
            {
                $project: {
                    "userObj.firstName": 1,
        ...
        // const totalResults = await Artwork.countDocuments(arrgre);
